 ...
 <?php
   ...
   for($i=0;$i<$len;$i++){ ?>
      <tr>         
       ...
       <td>
        <a href="Asignatura_edit.php?id=<?=$result[$i]->_get_id()?>">Edit</a>
        <a href="Asignatura_do_delete.php?id=<?=$result[$i]->_get_id()?>">Delete</a>
        <a href="Asignatura_details.php?id=<?=$result[$i]->_get_id()?>">Details</a>  
       </td>    
      </tr>
<?php }
 ?>
...
<br/>
<a href="Asignatura_insert.php">New</a>